...
<body>
  ...
  <form action="/login" method="post" style="min-width: 800px">
    ...
    <div class="screen-1" style="padding-top: 200px">
      ...
      <div class="email">
        ...
        <div class="sec-2">
          ...
          <input type="text" name="username" placeholder="john_doe123" value="<?= old("username") ?>" />
        </div>
      </div>
      ...
      <div class="footer"><a class="login" href="http://localhost:3000/signup"
          style="font-size: 1rem; text-decoration: none;background-color: #2e849a;color:white;padding: 0.7rem;border-radius: 30px;text-align: center;margin:auto">Signup</a>
      </div>
